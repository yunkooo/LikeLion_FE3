...
console.log('true' === true) // false
// 1. json에서 값을 가져올때 true 문자열로 가져와서 error가 난적 있습니다.
// 2. json에서 값을 가져올때 true가 True로 되어있어서 error가 난적이 있습니다.
...
console.log(false == NaN) // 주의 : false
console.log(false === NaN) // 주의 : false
...
// [].length 를 하면 0 이 나온다. 속성이 있다.
truthyAndFalsy({}) // 주의 :true

truthyAndFalsy('') // 주의 : false
// ''.length 를 하면 0 이 나오지만 false
